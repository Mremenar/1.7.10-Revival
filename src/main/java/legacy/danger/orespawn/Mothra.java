...
public class Mothra extends EntityButterfly implements IMob
{
    ...
    protected void func_70619_bc() {
        ...
        if (this.stuck_count > 50 || this.field_70170_p.field_73012_v.nextInt(300) == 0 || this.currentFlightTarget.func_71569_e((int)this.field_70165_t, (int)this.field_70163_u, (int)this.field_70161_v) < 9.0f) {
            ...
            for (Block bid = Blocks.field_150348_b; bid != Blocks.field_150350_a && keep_trying != 0; --keep_trying) {
                ...
                newx *= xdir;
                this.currentFlightTarget.func_71571_b((int)this.field_70165_t + newx, (int)this.field_70163_u + this.field_70146_Z.nextInt(7) - 1 - down, (int)this.field_70161_v + newz);
            ...
            target = (EntityPlayer)this.field_70170_p.func_72857_a((Class)EntityPlayer.class, this.field_70121_D.func_72314_b(25.0, 20.0, 25.0), (Entity)this);
            if (target != null) {
    ...
    public boolean func_70601_bi() {
        ...
        Mothra target = null;
        target = (Mothra)this.field_70170_p.func_72857_a((Class)Mothra.class, this.field_70121_D.func_72314_b(64.0, 32.0, 64.0), (Entity)this);
        return target == null;
    }
    ...
    protected void func_70628_a(final boolean par1, final int par2) {
        ...
        for (int var4 = 0; var4 < 20; ++var4) {
            spawnCreature(this.field_70170_p, "Moth", this.field_70165_t + 0.5, this.field_70163_u + 1.0, this.field_70161_v + 0.5);
        }
    }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.field_70170_p.func_72872_a((Class)EntityLivingBase.class, this.field_70121_D.func_72314_b(15.0, 20.0, 15.0));
