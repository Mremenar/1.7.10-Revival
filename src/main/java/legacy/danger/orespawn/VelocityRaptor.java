...
public class VelocityRaptor extends EntityCannonFodder
{
    ...
    public VelocityRaptor(final World par1World) {
        ...
        this.field_70714_bg.func_75776_a(3, (EntityAIBase)new MyEntityAIAvoidEntity((EntityCreature)this, EntityMob.class, 8.0f, 1.0, 1.399999976158142));
        this.field_70714_bg.func_75776_a(4, (EntityAIBase)new EntityAITempt((EntityCreature)this, 1.25, Items.field_151034_e, false));
        this.field_70714_bg.func_75776_a(5, (EntityAIBase)new EntityAIPanic((EntityCreature)this, 1.600000023841858));
    ...
    private boolean scan_it(final int x, final int y, final int z, final int dx, final int dy, final int dz) {
        ...
        for (int i = -dy; i <= dy; ++i) {
            for (int j = -dz; j <= dz; ++j) {
                ...
                if (bid == Blocks.field_150329_H || bid == Blocks.field_150327_N || bid == Blocks.field_150328_O || bid == Blocks.field_150330_I || bid == Blocks.field_150398_cm) {
    ...
    public boolean func_70085_c(final EntityPlayer par1EntityPlayer) {
        ...
        if (var2 != null && var2.func_77973_b() == Items.field_151034_e && par1EntityPlayer.func_70068_e((Entity)this) < 16.0) {
            if (!this.func_70909_n()) {
                ...
                if (this.field_70170_p.field_72995_K) {
                    this.func_70908_e(true);
                    this.field_70170_p.func_72960_a((Entity)this, (byte)7);
                    par1EntityPlayer.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.6000000238418579);
                }
        ...
        if (this.func_70909_n() && var2 != null && var2.func_77973_b() == Item.func_150898_a((Block)Blocks.field_150330_I) && par1EntityPlayer.func_70068_e((Entity)this) < 16.0 && this.func_152114_e((EntityLivingBase)par1EntityPlayer)) {
            if (!this.field_70170_p.field_72995_K) {
                ...
                par1EntityPlayer.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.30000001192092896);
            }
            if (!par1EntityPlayer.field_71075_bZ.field_75098_d) {
    ...
    protected boolean func_70692_ba() {
        ...
        return !this.func_70909_n() && !this.func_104002_bU();
    }
