...
public class ModelRubberDucky extends ModelBase
{
    ...
    public ModelRubberDucky(final float f1) {
        ...
        (this.bottom = new ModelRenderer((ModelBase)this, 0, 56)).func_78789_a(-2.0f, 0.0f, -2.0f, 4, 1, 4);
        ...
        (this.body = new ModelRenderer((ModelBase)this, 0, 45)).func_78789_a(-3.0f, 0.0f, -3.0f, 6, 2, 8);
        this.body.func_78793_a(0.0f, 21.0f, 0.0f);
        this.body.func_78787_b(64, 64);
        this.body.field_78809_i = true;
        this.setRotation(this.body, 0.0f, 0.0f, 0.0f);
        (this.back = new ModelRenderer((ModelBase)this, 0, 33)).func_78789_a(-3.0f, 0.0f, -3.0f, 6, 1, 10);
        this.back.func_78793_a(0.0f, 20.0f, 0.0f);
        this.back.func_78787_b(64, 64);
        this.back.field_78809_i = true;
        this.setRotation(this.back, 0.0f, 0.0f, 0.0f);
        (this.neck = new ModelRenderer((ModelBase)this, 17, 27)).func_78789_a(-1.0f, 0.0f, -1.0f, 2, 1, 2);
        this.neck.func_78793_a(0.0f, 19.0f, -1.0f);
        this.neck.func_78787_b(64, 64);
        this.neck.field_78809_i = true;
        this.setRotation(this.neck, 0.0f, 0.0f, 0.0f);
        (this.head = new ModelRenderer((ModelBase)this, 13, 18)).func_78789_a(-2.0f, -4.0f, -2.0f, 4, 4, 4);
        this.head.func_78793_a(0.0f, 19.0f, -1.0f);
        this.head.func_78787_b(64, 64);
        this.head.field_78809_i = true;
        this.setRotation(this.head, 0.0f, 0.0f, 0.0f);
        (this.beak = new ModelRenderer((ModelBase)this, 0, 21)).func_78789_a(-1.5f, -1.0f, -5.0f, 3, 1, 3);
        ...
        (this.Lwing = new ModelRenderer((ModelBase)this, 0, 0)).func_78789_a(0.0f, -0.5f, 0.0f, 2, 1, 5);
        ...
        (this.Rwing = new ModelRenderer((ModelBase)this, 17, 0)).func_78789_a(-2.0f, -0.5f, 0.0f, 2, 1, 5);
    ...
    public void func_78088_a(final Entity entity, final float f, final float f1, final float f2, final float f3, final float f4, final float f5) {
        ...
        this.head.field_78795_f = (float)Math.toRadians(f4) * 0.65f;
