...
public class OreSpawnWorld implements IWorldGenerator
{
    ...
    public void generateSurface(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        if (OreSpawnMain.DisableOverworldDungeons == 0 && world.field_73011_w.field_76574_g == 0 && OreSpawnWorld.recently_placed == 0) {
            final int i = world.field_73012_v.nextInt(6);
            if (i == 0) {
        ...
        final BiomeGenBase b = world.func_72807_a(chunkX, chunkZ);
            ...
            if (randPosY <= OreSpawnMain.Ruby_stats.maxdepth && randPosY >= OreSpawnMain.Ruby_stats.mindepth) {
                for (int m = randPosY; m > 5; --m) {
                    ...
                    if (bid == Blocks.field_150353_l || bid == Blocks.field_150356_k) {
                        bid = world.func_147439_a(randPosX, m - 1, randPosZ);
    ...
    public void generateOres(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        if (OreSpawnMain.Ruby_stats.rate > 0) {
            for (int patchy = OreSpawnMain.Ruby_stats.rate + random.nextInt(5), i = 0; i < patchy; ++i) {
                final int randPosX = 3 + chunkX + random.nextInt(10);
                final int randPosY = random.nextInt(128);
                final int randPosZ = 3 + chunkZ + random.nextInt(10);
                if (randPosY <= OreSpawnMain.Ruby_stats.maxdepth && randPosY >= OreSpawnMain.Ruby_stats.mindepth) {
    ...
    public void addStrawberries(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        if (world.field_73011_w.field_76574_g == OreSpawnMain.DimensionID || b.field_76791_y.equals("Forest") || b.field_76791_y.equals("ForestHills") || b.field_76791_y.equals("Birch Forest Hills") || b.field_76791_y.equals("Birch Forest")) {
            for (int i = 0; i < 5; ++i) {
                for (int posX = chunkX + random.nextInt(16), posZ = chunkZ + random.nextInt(16), posY = 100; posY > 40 && world.func_147437_c(posX, posY, posZ); --posY) {
                    if (world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150349_c) {
    ...
    public boolean addANest(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        if (b.field_76791_y.equals("Forest") || b.field_76791_y.equals("ForestHills") || b.field_76791_y.equals("Jungle") || b.field_76791_y.equals("JungleHills") || b.field_76791_y.equals("Birch Forest") || b.field_76791_y.equals("Birch Forest Hills")) {
            for (int i = 0; i < 5; ++i) {
                for (int posX = chunkX + random.nextInt(16), posZ = chunkZ + random.nextInt(16), posY = 128; posY > 40 && world.func_147437_c(posX, posY, posZ); --posY) {
                    if (world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150349_c) {
    ...
    public void addCorn(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        if (world.field_73011_w.field_76574_g == OreSpawnMain.DimensionID || world.field_73011_w.field_76574_g == OreSpawnMain.DimensionID3 || b.field_76791_y.equals("Plains")) {
            for (int j = 0; j < nc; ++j) {
                ...
                is_all_air = 1;
                int posY = 100;
                while (posY > 40 && world.func_147437_c(posX, posY, posZ)) {
                    if (world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150349_c) {
                        for (int i = 1; i < 10; ++i) {
                            if (!world.func_147437_c(posX, posY + i, posZ)) {
                                is_all_air = 0;
                            }
                        }
                        if (is_all_air == 0) {
        ...
        if (b.field_76791_y.equals("Ocean")) {
            for (int i = 0; i < 4; ++i) {
                ...
                for (int posY = 100; posY > 40; --posY) {
                    if (world.func_147439_a(posX, posY, posZ) == Blocks.field_150350_a && world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150355_j) {
    ...
    public void addFrogPond(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        if (b.field_76791_y.equals("Plains")) {
            for (int i = 0; i < 4; ++i) {
                ...
                final int which = 0;
                for (int posY = 100; posY > 40; --posY) {
                    if (world.func_147439_a(posX, posY, posZ) == Blocks.field_150350_a && world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150349_c) {
    ...
    public boolean addIgloo(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        if (b.field_76791_y.equals("Ice Plains")) {
            for (int i = 0; i < 4; ++i) {
                ...
                final int which = 0;
                for (int posY = 100; posY > 40; --posY) {
                    if (world.func_147439_a(posX, posY, posZ) == Blocks.field_150350_a && world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150433_aE) {
    ...
    public boolean addBouncyCastle(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        if (b.field_76791_y.equals("Desert")) {
            for (int i = 0; i < 4; ++i) {
                ...
                final int which = 0;
                for (int posY = 100; posY > 40; --posY) {
                    if (world.func_147439_a(posX, posY, posZ) == Blocks.field_150350_a && world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150354_m) {
    ...
    public boolean addDamselInDistress(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            final int which = 0;
            for (int posY = 100; posY > 40; --posY) {
                if (world.func_147439_a(posX, posY, posZ) == Blocks.field_150350_a && world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150349_c && this.quickSpaceCheck(world, posX, posY - 1, posZ)) {
    ...
    public void addNetherMosquitos(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            for (int posY = 90; posY > 20; --posY) {
                if (world.func_147437_c(posX, posY, posZ) && world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150424_aL) {
                    OreSpawnMain.setBlockFast(world, posX, posY, posZ, OreSpawnMain.MyMosquitoPlant, 0, 2);
                    break;
                }
            }
    ...
    public void addEndKnights(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            for (int posY = 90; posY > 10; --posY) {
                if (world.func_147437_c(posX, posY, posZ) && world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150377_bs && this.quickSpaceCheck(world, posX, posY, posZ)) {
    ...
    public void addEnderCastle(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            final int posZ = chunkZ + random.nextInt(16);
            for (int posY = 90; posY > 10; --posY) {
                if (world.func_147437_c(posX, posY, posZ) && world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150377_bs && this.quickBigSpaceCheck(world, posX, posY, posZ)) {
    ...
    public void addUnstableAnts(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        for (int i = 0; i < 3; ++i) {
            for (int posX = chunkX + random.nextInt(16), posZ = chunkZ + random.nextInt(16), posY = 20; posY > 2 && world.func_147437_c(posX, posY, posZ); --posY) {
                if (world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150349_c) {
                    OreSpawnMain.setBlockFast(world, posX, posY - 1, posZ, OreSpawnMain.MyUnstableAntBlock, 0, 2);
                    break;
                }
    ...
    public void addCrystalTermites(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            for (int posY = 100; posY > 50; --posY) {
                if (world.func_147437_c(posX, posY, posZ) && world.func_147439_a(posX, posY - 1, posZ) == OreSpawnMain.CrystalGrass) {
    ...
    public void addIrukandji(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            final int posZ = chunkZ + random.nextInt(16);
            for (int posY = 100; posY > 50; --posY) {
                if (world.func_147437_c(posX, posY, posZ) && world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150355_j) {
                    OreSpawnMain.setBlockFast(world, posX, posY, posZ, Blocks.field_150474_ac, 0, 2);
                    final TileEntityMobSpawner tileentitymobspawner = (TileEntityMobSpawner)world.func_147438_o(posX, posY, posZ);
    ...
    public void addCrystalChestsAndSpawners(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        while (i < 3) {
            ...
            final int posY = 25;
            if (world.func_147437_c(posX, posY, posZ)) {
    ...
    public void addCrystalChest(final World world, final int x, final int y, final int z, final int dir) {
        ...
        if (i == 0) {
            ...
            final TileEntityChest chest = (TileEntityChest)world.func_147438_o(x, y, z);
            if (chest != null) {
                final Random field_73012_v = world.field_73012_v;
                final Trees oreSpawnTrees = OreSpawnMain.OreSpawnTrees;
                WeightedRandomChestContent.func_76293_a(field_73012_v, Trees.CrystalChestContentsList, (IInventory)chest, 1 + world.field_73012_v.nextInt(3));
            }
        }
        else {
            OreSpawnMain.setBlockFast(world, x, y, z, Blocks.field_150474_ac, 0, 2);
            final TileEntityMobSpawner tileentitymobspawner = (TileEntityMobSpawner)world.func_147438_o(x, y, z);
            if (tileentitymobspawner != null) {
    ...
    public boolean addAppleTrees(final World world, final Random random, final int chunkX, final int chunkZ, final Chunk chunk) {
        ...
        for (int i = 0; i < howmany; ++i) {
            for (int posX = 2 + chunkX + random.nextInt(12), posZ = 2 + chunkZ + random.nextInt(12), posY = 100; posY > 50 && world.func_147437_c(posX, posY, posZ); --posY) {
                if (world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150349_c) {
    ...
    public boolean addHugeTree(final World world, final Random random, final int chunkX, final int chunkZ, final Chunk chunk) {
        ...
        for (int i = 0; i < 3 && made_one == 0; ++i) {
            ...
            for (int posY = 127; posY > 50 && made_one == 0; --posY) {
                if (world.func_147437_c(posX, posY, posZ) && world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150349_c) {
                    ...
                    if (rand_treetype > 75) {
                        ...
                        a.MakeBigSquareTree(world, posX, posY - 1, posZ, Blocks.field_150364_r, leaf_type, Blocks.field_150341_Y, tree_type, tree_radius, no_critters, chunk);
                    }
                        ...
                        a.MakeBigCircularTree(world, posX, posY - 1, posZ, Blocks.field_150364_r, leaf_type, Blocks.field_150341_Y, tree_type, tree_radius, no_critters, chunk);
                    }
                    else {
                        tree_radius = 6 - random.nextInt(3);
                        a.MakeBigRoundTree(world, posX, posY - 1, posZ, Blocks.field_150364_r, leaf_type, Blocks.field_150341_Y, tree_type, tree_radius, chunk);
                    }
                    made_one = 1;
                    break;
                }
    ...
    public void addRocks(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        for (int howmany = 3 + random.nextInt(10), i = 0; i < howmany; ++i) {
            for (int posX = chunkX + random.nextInt(16), posZ = chunkZ + random.nextInt(16), posY = 110; posY > 40 && world.func_147439_a(posX, posY, posZ) == Blocks.field_150350_a; --posY) {
                final Block bid = world.func_147439_a(posX, posY - 1, posZ);
                if (bid == Blocks.field_150349_c || bid == Blocks.field_150354_m || bid == OreSpawnMain.CrystalGrass) {
    ...
    public void addD4Rocks(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        for (int howmany = 3 + random.nextInt(10), i = 0; i < howmany; ++i) {
            for (int posX = chunkX + random.nextInt(16), posZ = chunkZ + random.nextInt(16), posY = 20; posY > 5 && world.func_147439_a(posX, posY, posZ) == Blocks.field_150350_a; --posY) {
                if (world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150349_c) {
                    this.spawnCreature(world, "Rock", posX, posY, posZ);
                    break;
                }
    ...
    public boolean addFairyTree(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        for (int posY = 128; posY > 40; --posY) {
            if (world.func_147437_c(posX, posY, posZ) && world.func_147439_a(posX, posY - 1, posZ) == OreSpawnMain.CrystalGrass) {
                for (int i = -8; i <= 8; ++i) {
                    for (int j = -8; j <= 8; ++j) {
                        final Block bid = world.func_147439_a(posX + i, posY, posZ + j);
                        if (bid != Blocks.field_150350_a) {
                            return false;
                        }
                    }
                ...
                for (int i = -2; i <= 2; ++i) {
                    for (int j = -2; j <= 2; ++j) {
                        final Block bid = world.func_147439_a(posX + i, posY - 1, posZ + j);
    ...
    public boolean addRubyDungeon(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        for (int i = 0; i < 8; ++i) {
            ...
            for (int posY = 50; posY > 5; --posY) {
                if (world.func_147439_a(posX, posY, posZ) == Blocks.field_150353_l) {
    ...
    public boolean addBeeHive(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        for (int i = 0; i < 16; i += 3) {
            for (int j = 0; j < 16; j += 3) {
                ...
                int posY = 128;
                while (posY > 30) {
                    if (world.func_147439_a(posX, posY + 1, posZ) == Blocks.field_150350_a && world.func_147439_a(posX, posY, posZ) == Blocks.field_150349_c) {
                        if (posY < lowestY) {
                            lowestY = posY;
                            lowestX = posX;
                            lowestZ = posZ;
    ...
    public boolean addD4RubyDungeon(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        for (int posY = 20; posY > 4; --posY) {
            final Block bid = world.func_147439_a(posX, posY, posZ);
    ...
    public void addLavaAndWater(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        for (int i = 0; i < 6; ++i) {
            ...
            final int posZ = chunkZ + random.nextInt(16);
            int posY = 128;
            while (posY > 75 && world.func_147437_c(posX, posY, posZ)) {
                if (world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150349_c) {
                    Block bid = world.func_147439_a(posX, posY - 2, posZ);
                    if (bid != Blocks.field_150346_d && bid != Blocks.field_150348_b) {
                        break;
                    }
                    int air = 0;
                    int non_air = 0;
                    ...
                    bid = world.func_147439_a(posX, posY - 1, posZ + 1);
                    if (bid == Blocks.field_150350_a) {
                        ++air;
                    }
                    if (bid == Blocks.field_150346_d || bid == Blocks.field_150348_b || bid == Blocks.field_150349_c) {
    ...
    public boolean addOtherTrees(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        if (world.field_73011_w.field_76574_g == OreSpawnMain.DimensionID) {
            ...
            for (int i = 0; i < nc; ++i) {
                ...
                int posY = 100;
                while (posY > 50 && world.func_147437_c(posX, posY, posZ)) {
                    if (world.func_147439_a(posX, posY - 1, posZ) == Blocks.field_150349_c) {
                        ++count;
                        if (what == 0) {
    ...
    public void addBasiliskMaze(final World world, final Random random, final int chunkX, final int chunkZ) {
        ...
        for (int i = 0; i < 16; i += 3) {
            for (int j = 0; j < 16; j += 3) {
                ...
                int posY = 128;
                while (posY > 30) {
                    if (world.func_147439_a(posX, posY + 1, posZ) == Blocks.field_150350_a && world.func_147439_a(posX, posY, posZ) != Blocks.field_150350_a) {
                        if (posY < lowestY) {
                            lowestY = posY;
                            lowestX = posX;
                            lowestZ = posZ;
    ...
    private boolean quickSpaceCheck(final World world, final int posX, final int posY, final int posZ) {
        for (int i = -2; i < 10; ++i) {
            for (int k = -2; k < 10; ++k) {
                if (world.func_147439_a(posX + i, posY + 4, posZ + k) != Blocks.field_150350_a) {
                    return false;
                }
            }
        }
    ...
    private boolean quickBigSpaceCheck(final World world, final int posX, final int posY, final int posZ) {
        for (int i = -5; i < 25; ++i) {
            for (int k = -5; k < 25; ++k) {
                if (world.func_147439_a(posX + i, posY + 8, posZ + k) != Blocks.field_150350_a) {
                    return false;
                }
            }
        }
    ...
    private boolean D4BigSpaceCheck(final World world, final int posX, final int posY, final int posZ) {
        for (int i = -25; i < 40; ++i) {
            for (int k = -25; k < 30; ++k) {
                final Block bid = world.func_147439_a(posX + i, posY + 4, posZ + k);
                if (bid != Blocks.field_150350_a) {
                    if (bid != Blocks.field_150364_r) {
                        if (bid != OreSpawnMain.MyAppleLeaves) {
                            if (bid != OreSpawnMain.MyScaryLeaves) {
