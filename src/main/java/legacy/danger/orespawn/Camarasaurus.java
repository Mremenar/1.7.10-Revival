...
public class Camarasaurus extends EntityTameable
{
    ...
    public Camarasaurus(final World par1World) {
        ...
        this.field_70714_bg.func_75776_a(3, (EntityAIBase)new EntityAIAvoidEntity((EntityCreature)this, (Class)EntityMob.class, 8.0f, 1.0, 1.399999976158142));
    ...
    private boolean scan_it(final int x, final int y, final int z, final int dx, final int dy, final int dz) {
        ...
        for (int i = -dy; i <= dy; ++i) {
            for (int j = -dz; j <= dz; ++j) {
                ...
                if (bid == Blocks.field_150362_t || bid == Blocks.field_150395_bd || bid == Blocks.field_150329_H || bid == Blocks.field_150434_aF || bid == Blocks.field_150398_cm) {
