...
public class Vortex extends EntityMob
{
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.3499999940395355);
    ...
    public void func_70071_h_() {
        ...
        if (e != null) {
            ...
            if (this.field_70170_p.field_72995_K) {
                for (int i = 0; i < 20; ++i) {
                    ...
                    this.field_70170_p.func_72869_a("smoke", this.field_70165_t + dx, this.field_70163_u + 0.75 + d, this.field_70161_v + dz, Math.cos(dir) * this.field_70170_p.field_73012_v.nextFloat() / 4.0, (double)(this.field_70170_p.field_73012_v.nextFloat() / 2.0f), Math.sin(dir) * this.field_70170_p.field_73012_v.nextFloat() / 4.0);
                }
            }
        }
        ...
        t %= 24000L;
        if (t < 12000L && this.field_70170_p.field_73012_v.nextInt(500) == 1) {
            this.func_70106_y();
        }
    }
    ...
    protected void func_70619_bc() {
        ...
        if (e != null) {
            ...
            final double d = this.func_70068_e((Entity)e);
            if (d < 81.0 && this.winded == 0) {
                final double a = Math.atan2(this.field_70161_v - e.field_70161_v, this.field_70165_t - e.field_70165_t);
                double pm = 1.0;
                if (e instanceof EntityPlayer) {
                    pm = 2.0;
                }
                e.func_70024_g(Math.cos(a) * (10.0 - Math.sqrt(d)) * 0.10000000149011612, (10.0 - Math.sqrt(d)) * 0.05000000074505806 * pm, Math.sin(a) * (10.0 - Math.sqrt(d)) * 0.10000000149011612);
            }
            if (this.func_70068_e((Entity)e) < (4.0f + e.field_70130_N / 2.0f) * (4.0f + e.field_70130_N / 2.0f) && this.field_70146_Z.nextInt(8) == 2) {
    ...
    public boolean func_70601_bi() {
        ...
        Vortex target = null;
        target = (Vortex)this.field_70170_p.func_72857_a((Class)Vortex.class, this.field_70121_D.func_72314_b(20.0, 16.0, 20.0), (Entity)this);
        return target == null;
    }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.field_70170_p.func_72872_a((Class)EntityLivingBase.class, this.field_70121_D.func_72314_b(16.0, 10.0, 16.0));
    ...
    private ItemStack dropItemRand(final Item index, final int par1) {
        ...
        var3 = new EntityItem(this.field_70170_p, this.field_70165_t + OreSpawnMain.OreSpawnRand.nextInt(6) - OreSpawnMain.OreSpawnRand.nextInt(6), this.field_70163_u + 1.0 + this.field_70170_p.field_73012_v.nextInt(10), this.field_70161_v + OreSpawnMain.OreSpawnRand.nextInt(6) - OreSpawnMain.OreSpawnRand.nextInt(6), is);
        if (var3 != null) {
    ...
    protected void func_70628_a(final boolean par1, final int par2) {
        ...
        for (int i = 5 + this.field_70170_p.field_73012_v.nextInt(7), var4 = 0; var4 < i; ++var4) {
            final int var5 = this.field_70170_p.field_73012_v.nextInt(10);
            if (var5 == 0) {
            ...
            if (var5 == 8) {
                this.dropItemRand(Item.func_150898_a(OreSpawnMain.CrystalCoal), 1);
            }
        }
    }
