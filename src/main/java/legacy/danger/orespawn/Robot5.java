...
public class Robot5 extends EntityMob
{
    ...
    protected void func_70628_a(final boolean par1, final int par2) {
        ...
        for (int i = 2 + this.field_70170_p.field_73012_v.nextInt(5), var6 = 0; var6 < i; ++var6) {
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.field_70170_p.func_72872_a((Class)EntityLivingBase.class, this.field_70121_D.func_72314_b(30.0, 6.0, 30.0));
