...
public class ChunkProviderOreSpawn2 implements IChunkProvider
{
    ...
    public void func_73153_a(final IChunkProvider par1IChunkProvider, final int par2, final int par3) {
        ...
        if (biomegenbase != BiomeGenBase.field_76769_d && biomegenbase != BiomeGenBase.field_76786_s && !flag && this.rand.nextInt(4) == 0 && TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, PopulateChunkEvent.Populate.EventType.LAKE)) {
            final int k2 = k + this.rand.nextInt(16) + 8;
            final int l2 = this.rand.nextInt(256);
            final int i2 = l + this.rand.nextInt(16) + 8;
            new WorldGenLakes(Blocks.field_150355_j).func_76484_a(this.worldObj, this.rand, k2, l2, i2);
        }
        if (TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, PopulateChunkEvent.Populate.EventType.LAVA) && !flag && this.rand.nextInt(8) == 0) {
            ...
            if (l2 < 63 || this.rand.nextInt(10) == 0) {
                new WorldGenLakes(Blocks.field_150353_l).func_76484_a(this.worldObj, this.rand, k2, l2, i2);
            }
        }
        int k2;
        int l2;
        ...
        for (doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, PopulateChunkEvent.Populate.EventType.DUNGEON), k2 = 0; doGen && k2 < 8; ++k2) {
            ...
            new WorldGenDungeons().func_76484_a(this.worldObj, this.rand, l2, i2, j2);
        }
        ...
        for (doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, PopulateChunkEvent.Populate.EventType.ICE), k2 = 0; doGen && k2 < 16; ++k2) {
            for (int l2 = 0; l2 < 16; ++l2) {
                i2 = this.worldObj.func_72874_g(k + k2, l + l2);
                if (this.worldObj.func_72884_u(k2 + k, i2 - 1, l2 + l)) {
                    this.worldObj.func_147465_d(k2 + k, i2 - 1, l2 + l, Blocks.field_150432_aD, 0, 2);
                }
                if (this.worldObj.func_147478_e(k2 + k, i2, l2 + l, true)) {
                    this.worldObj.func_147465_d(k2 + k, i2, l2 + l, Blocks.field_150431_aC, 0, 2);
                }
            }
        }
    ...
    public List func_73155_a(final EnumCreatureType par1EnumCreatureType, final int par2, final int par3, final int par4) {
        final BiomeGenBase var5 = this.worldObj.func_72807_a(par2, par4);
        List l = null;
        if (var5 != null) {
