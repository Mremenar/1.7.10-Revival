...
public class ChunkProviderOreSpawn6 implements IChunkProvider
{
    ...
    public void replaceBiomeBlocks(final int p_147418_1_, final int p_147418_2_, final Block[] p_147418_3_, final byte[] meta, final BiomeGenBase[] biomes) {
        ...
        for (int k = 0; k < 16; ++k) {
            for (int l = 0; l < 16; ++l) {
                ...
                int j1 = -1;
                Block block = (Block)Blocks.field_150349_c;
                        ...
                        if (block3 != null && block3.func_149688_o() != Material.field_151579_a) {
                            if (block3 == Blocks.field_150348_b) {
                                if (j1 == -1) {
                                    ...
                                    if (k2 < b0 && block == Blocks.field_150350_a) {
    ...
    public Chunk func_73158_c(final int p_73158_1_, final int p_73158_2_) {
        return this.func_73154_d(p_73158_1_, p_73158_2_);
    }
    
    public Chunk func_73154_d(final int p_73154_1_, final int p_73154_2_) {
    ...
    private double[] initializeNoiseField(double[] p_73164_1_, final int p_73164_2_, final int p_73164_3_, final int p_73164_4_, final int p_73164_5_, final int p_73164_6_, final int p_73164_7_) {
        ...
        this.noiseData1 = this.netherNoiseGen3.func_76304_a(this.noiseData1, p_73164_2_, p_73164_3_, p_73164_4_, p_73164_5_, p_73164_6_, p_73164_7_, d0 / 80.0, d2 / 60.0, d0 / 80.0);
        this.noiseData2 = this.netherNoiseGen1.func_76304_a(this.noiseData2, p_73164_2_, p_73164_3_, p_73164_4_, p_73164_5_, p_73164_6_, p_73164_7_, d0, d2, d0);
        this.noiseData3 = this.netherNoiseGen2.func_76304_a(this.noiseData3, p_73164_2_, p_73164_3_, p_73164_4_, p_73164_5_, p_73164_6_, p_73164_7_, d0, d2, d0);
    ...
    public boolean func_73149_a(final int p_73149_1_, final int p_73149_2_) {
        return true;
    }
    
    public void func_73153_a(final IChunkProvider p_73153_1_, final int par2, final int par3) {
        BlockFalling.field_149832_M = false;
        final int var4 = par2 * 16;
        final int var5 = par3 * 16;
        final BiomeGenBase var6 = this.worldObj.func_72807_a(var4 + 16, var5 + 16);
        var6.func_76728_a(this.worldObj, this.worldObj.field_73012_v, var4, var5);
        SpawnerAnimals.func_77191_a(this.worldObj, var6, var4 + 8, var5 + 8, 16, 16, this.worldObj.field_73012_v);
    }
    
    public boolean func_73151_a(final boolean p_73151_1_, final IProgressUpdate p_73151_2_) {
        return true;
    }
    ...
    public List func_73155_a(final EnumCreatureType p_73155_1_, final int p_73155_2_, final int p_73155_3_, final int p_73155_4_) {
        final BiomeGenBase biomegenbase = this.worldObj.func_72807_a(p_73155_2_, p_73155_4_);
    ...
    public void func_82695_e(final int p_82695_1_, final int p_82695_2_) {
    }
