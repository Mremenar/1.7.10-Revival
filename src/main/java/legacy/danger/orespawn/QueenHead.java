...
public class QueenHead extends EntityLiving
{
    ...
    public boolean func_70097_a(final DamageSource par1DamageSource, final float par2) {
        ...
        final List var5 = this.field_70170_p.func_72872_a((Class)TheQueen.class, this.field_70121_D.func_72314_b(48.0, 32.0, 48.0));
    ...
    public void func_70071_h_() {
        ...
        if (this.field_70170_p.field_72995_K) {
            ...
            final List var5 = this.field_70170_p.func_72872_a((Class)TheQueen.class, this.field_70121_D.func_72314_b(32.0, 32.0, 32.0));
            final Iterator var6 = var5.iterator();
            Entity var7 = null;
            TheQueen var8 = null;
            if (var6.hasNext()) {
                var7 = var6.next();
                var8 = (TheQueen)var7;
                this.field_70163_u = var8.field_70163_u + 12.0;
                this.field_70165_t = var8.field_70165_t - 30.0 * Math.sin(Math.toRadians(var8.field_70759_as));
                this.field_70161_v = var8.field_70161_v + 30.0 * Math.cos(Math.toRadians(var8.field_70759_as));
