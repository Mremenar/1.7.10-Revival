...
public class Nastysaurus extends EntityMob
{
    ...
    private void dropItemRand(final Item index, final int par1) {
        final EntityItem var3 = new EntityItem(this.field_70170_p, this.field_70165_t + OreSpawnMain.OreSpawnRand.nextInt(4) - OreSpawnMain.OreSpawnRand.nextInt(4), this.field_70163_u + 3.0, this.field_70161_v + OreSpawnMain.OreSpawnRand.nextInt(4) - OreSpawnMain.OreSpawnRand.nextInt(4), new ItemStack(index, par1, 0));
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.field_70170_p.func_72872_a((Class)EntityLivingBase.class, this.field_70121_D.func_72314_b(32.0, 8.0, 32.0));
    ...
    public boolean func_70601_bi() {
        ...
        target = (Nastysaurus)this.field_70170_p.func_72857_a((Class)Nastysaurus.class, this.field_70121_D.func_72314_b(16.0, 8.0, 16.0), (Entity)this);
        return target == null;
    }
}
