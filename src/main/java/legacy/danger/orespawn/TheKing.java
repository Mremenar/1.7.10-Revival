...
public class TheKing extends EntityMob
{
    ...
    protected void func_70628_a(final boolean par1, final int par2) {
        Item it = null;
        Block bl = null;
        spawnCreature(this.field_70170_p, "The Prince", this.field_70165_t, this.field_70163_u + 10.0, this.field_70161_v);
        ...
        while (j < 150) {
            int k;
            for (k = 1 + this.field_70170_p.field_73012_v.nextInt(icount), ilist = Item.field_150901_e.iterator(); k > 0 && ilist.hasNext(); --k) {
                it = ilist.next();
            }
            if (it != null) {
                ++j;
        ...
        while (j < 150) {
            int k;
            for (k = 1 + this.field_70170_p.field_73012_v.nextInt(bcount), blist = Block.field_149771_c.iterator(); k > 0 && blist.hasNext(); --k) {
                bl = blist.next();
            }
            if (bl != null) {
                ++j;
                this.dropItemRand(Item.func_150898_a(bl), 1);
            }
        }
    }
    ...
    public void func_70071_h_() {
        ...
        if (this.player_hit_count < 10 && this.func_110143_aJ() < this.mygetMaxHealth() / 8) {
    ...
    private void msgToPlayers(final String s) {
        final List var5 = this.field_70170_p.func_72872_a((Class)EntityPlayer.class, this.field_70121_D.func_72314_b(80.0, 64.0, 80.0));
        ...
        while (var6.hasNext()) {
            ...
            var8.func_146105_b((IChatComponent)new ChatComponentText(s));
        }
    }
    ...
    protected void func_70619_bc() {
        ...
        if (this.isEnd != 1) {
            ...
            if (this.tooFarFromHome() || this.field_70170_p.field_73012_v.nextInt(200) == 0 || this.currentFlightTarget.func_71569_e((int)this.field_70165_t, (int)this.field_70163_u, (int)this.field_70161_v) < 9.1f) {
                ...
                if (this.head_found == 0) {
                    final EntityLiving entityLiving = (EntityLiving)spawnCreature(this.field_70170_p, "KingHead", this.field_70165_t, this.field_70163_u + 20.0, this.field_70161_v);
                }
                if (e == null) {
                    e = f;
                }
                if (e != null) {
                    ...
                    final double dx = this.field_70165_t + 20.0 * Math.sin(Math.toRadians(this.field_70759_as));
                    final double dz = this.field_70161_v - 20.0 * Math.cos(Math.toRadians(this.field_70759_as));
            ...
            this.field_70179_y += (Math.signum(var3) * 0.7 - this.field_70179_y) * 0.35;
            ...
            if (this.field_70170_p.field_73012_v.nextInt(30) == 1 && this.func_110143_aJ() < this.mygetMaxHealth()) {
        ...
        if (p != null) {
            ...
            p.field_70181_x = 0.0;
            p.field_70179_y = 0.0;
            final double dd0 = this.field_70165_t - p.field_70165_t;
            final double dd2 = this.field_70161_v - p.field_70161_v;
    ...
    public boolean func_70097_a(final DamageSource par1DamageSource, final float par2) {
        ...
        if (e != null && e instanceof EntityLivingBase) {
            ...
            final float s = enl.field_70131_O * enl.field_70130_N;
    ...
    public boolean MyCanSee(final EntityLivingBase e) {
        ...
        float starty = (float)(this.field_70163_u + this.field_70131_O * 7.0f / 8.0f);
        ...
        for (int i = 0; i < nblks; ++i) {
            ...
            if (bid != Blocks.field_150358_i && bid != Blocks.field_150355_j && bid != Blocks.field_150362_t) {
                if (bid != Blocks.field_150395_bd) {
                    if (bid != Blocks.field_150350_a) {
                        return false;
                    }
                }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        if (this.isEnd == 2) {
            final List var5p = this.field_70170_p.func_72872_a((Class)EntityPlayer.class, this.field_70121_D.func_72314_b(80.0, 64.0, 80.0));
        ...
        final List var5 = this.field_70170_p.func_72872_a((Class)EntityLivingBase.class, this.field_70121_D.func_72314_b(80.0, 64.0, 80.0));
        Collections.sort((List<Object>)var5, this.TargetSorter);
        final Iterator var6 = var5.iterator();
        Entity var7 = null;
