...
public class WorldProviderOreSpawn4 extends WorldProvider
{
    ...
    public WorldProviderOreSpawn4() {
        this.MyPlains = (BiomeGenUtopianPlains)new BiomeGenUtopianPlains(OreSpawnMain.BiomeIslandsID).func_76739_b(353825).func_76735_a("Islands").func_76732_a(0.7f, 0.5f);
    }
    ...
    public void func_76572_b() {
        ...
        this.field_76578_c = (WorldChunkManager)new WorldChunkManagerHell((BiomeGenBase)this.MyPlains, 0.01f);
    ...
    public IChunkProvider func_76555_c() {
        return (IChunkProvider)new ChunkProviderOreSpawn4(this.field_76579_a, this.field_76579_a.func_72905_C(), true);
    }
}
