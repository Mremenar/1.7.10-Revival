...
public class EnderKnight extends EntityMob
{
    ...
    protected Entity func_70782_k() {
        ...
        final EntityPlayer entityplayer = this.field_70170_p.func_72856_b((Entity)this, 64.0);
    ...
    public void func_70636_d() {
        ...
        if (this.lastEntityToAttack != this.field_70789_a) {
            ...
            attributeinstance.func_111124_b(EnderKnight.attackingSpeedBoostModifier);
            if (this.field_70789_a != null) {
                attributeinstance.func_111121_a(EnderKnight.attackingSpeedBoostModifier);
            }
        }
    ...
    public boolean func_70601_bi() {
        ...
        return this.func_70814_o() && !this.field_70170_p.func_72935_r() && this.field_70163_u >= 30.0;
    }
    ...
    static {
        ...
        attackingSpeedBoostModifier = new AttributeModifier(EnderKnight.attackingSpeedBoostModifierUUID, "Attacking speed boost", 6.199999809265137, 0).func_111168_a(false);
    }
}
