...
public class ChunkProviderOreSpawn5 implements IChunkProvider
{
                ...
                if (block3 != null && block3.func_149688_o() != Material.field_151579_a) {
                    if (block3 == OreSpawnMain.CrystalStone) {
                        if (k == -1) {
                            ...
                            if (l2 < 63 && (block == null || block.func_149688_o() == Material.field_151579_a)) {
    ...
    public Chunk func_73154_d(final int par1, final int par2) {
        ...
        this.replaceBlocksForBiome(par1, par2, ablock, abyte, this.biomesForGeneration = this.worldObj.func_72959_q().func_76933_b(this.biomesForGeneration, par1 * 16, par2 * 16, 16, 16));
            ...
            for (int k1 = 0; k1 < 5; ++k1) {
                ...
                for (int l2 = -b0; l2 <= b0; ++l2) {
                    for (int i2 = -b0; i2 <= b0; ++i2) {
                        ...
                        if (this.field_147435_p == WorldType.field_151360_e && f4 > 0.0f) {
                            f4 = 1.0f + f4 * 2.0f;
                            f5 = 1.0f + f5 * 4.0f;
                        }
                ...
                for (int j2 = 0; j2 < 33; ++j2) {
                    ...
                    double d14 = MathHelper.func_151238_b(d11, d12, d13) - d10;
                    if (j2 > 29) {
    ...
    public void func_73153_a(final IChunkProvider par1IChunkProvider, final int par2, final int par3) {
        ...
        final int k = par2 * 16;
        final int l = par3 * 16;
        final BiomeGenBase biomegenbase = this.worldObj.func_72807_a(k + 16, l + 16);
        this.rand.setSeed(this.worldObj.func_72905_C());
        final long i1 = this.rand.nextLong() / 2L * 2L + 1L;
        final long j1 = this.rand.nextLong() / 2L * 2L + 1L;
        this.rand.setSeed(par2 * i1 + par3 * j1 ^ this.worldObj.func_72905_C());
    ...
    public void addCrystalTrees(final World world, final Random random, final int chunkX, final int chunkZ, final Chunk chunk) {
        ...
        for (int i = 0; i < howmany; ++i) {
            ...
            int posY = 128;
            while (posY > 40) {
                if (OreSpawnMain.getBlockIDInChunk(chunk, posX, posY, posZ) == Blocks.field_150350_a && OreSpawnMain.getBlockIDInChunk(chunk, posX, posY - 1, posZ) == OreSpawnMain.CrystalGrass) {
                    if (what == 0) {
    ...
    public void TallCrystalTree(final World world, final int x, int y, final int z, final Chunk chunk) {
        ...
        final int j = i + world.field_73012_v.nextInt(18 - OreSpawnMain.LessLag * 2);
        for (int k = 0; k < i; ++k) {
            final Block bid = OreSpawnMain.getBlockIDInChunk(chunk, x, y + k, z);
    ...
    public boolean generateOre(final World par1World, final Random par2Random, final int par3, final int par4, final int par5, final Chunk chunk, final Block newbid, final int numberOfBlocks, final Block oldbid) {
        ...
        final double d0 = par3 + 8 + MathHelper.func_76126_a(f) * numberOfBlocks / 8.0f;
        final double d2 = par3 + 8 - MathHelper.func_76126_a(f) * numberOfBlocks / 8.0f;
        final double d3 = par5 + 8 + MathHelper.func_76134_b(f) * numberOfBlocks / 8.0f;
        final double d4 = par5 + 8 - MathHelper.func_76134_b(f) * numberOfBlocks / 8.0f;
        ...
        for (int l = 0; l <= numberOfBlocks; ++l) {
            ...
            final double d11 = (MathHelper.func_76126_a(l * 3.1415927f / numberOfBlocks) + 1.0f) * d10 + 1.0;
            final double d12 = (MathHelper.func_76126_a(l * 3.1415927f / numberOfBlocks) + 1.0f) * d10 + 1.0;
            final int i1 = MathHelper.func_76128_c(d7 - d11 / 2.0);
            final int j1 = MathHelper.func_76128_c(d8 - d12 / 2.0);
            final int k1 = MathHelper.func_76128_c(d9 - d11 / 2.0);
            final int l2 = MathHelper.func_76128_c(d7 + d11 / 2.0);
            final int i2 = MathHelper.func_76128_c(d8 + d12 / 2.0);
            final int j2 = MathHelper.func_76128_c(d9 + d11 / 2.0);
