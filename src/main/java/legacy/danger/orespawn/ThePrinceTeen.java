...
public class ThePrinceTeen extends EntityTameable
{
    ...
    public void func_70619_bc() {
        ...
        if (this.kill_count > 25 && this.day_count > 10) {
            ...
            ent = spawnCreature(this.field_70170_p, "The Young Adult Prince", this.field_70165_t, this.field_70163_u, this.field_70161_v);
            if (ent != null) {
    ...
    private void fly_without_rider() {
        ...
        if (toofar == 0 && this.flyaway == 0 && this.field_70170_p.field_73013_u != EnumDifficulty.PEACEFUL && this.field_70170_p.field_73012_v.nextInt(7) == 1) {
        ...
        if (this.field_70170_p.field_72995_K) {
            ...
            if (this.getActivity() != 0) {
                ...
                if (this.field_70153_n != null) {
                    ...
                    if (!this.field_70170_p.field_72995_K) {
                        list = this.field_70170_p.func_72839_b((Entity)this, this.field_70121_D.func_72314_b(3.25, 4.0, 3.25));
    ...
    public boolean func_70085_c(final EntityPlayer par1EntityPlayer) {
        ...
        if (var2 != null && var2.func_77973_b() == Item.func_150898_a(Blocks.field_150484_ah) && par1EntityPlayer.func_70068_e((Entity)this) < 25.0) {
            if (!this.field_70170_p.field_72995_K) {
        ...
        if (this.func_70909_n()) {
            ...
            if (var2 != null && var2.func_77973_b() == Item.func_150898_a(Blocks.field_150432_aD) && par1EntityPlayer.func_70068_e((Entity)this) < 25.0) {
                if (!this.field_70170_p.field_72995_K) {
                    this.func_70908_e(true);
            ...
            if (var2 != null && var2.func_77973_b() == Items.field_151045_i && par1EntityPlayer.func_70068_e((Entity)this) < 25.0 && !this.field_70170_p.field_72995_K) {
                Entity ent = null;
                ThePrince d = null;
                ent = spawnCreature(this.field_70170_p, "The Prince", this.field_70165_t, this.field_70163_u, this.field_70161_v);
                if (ent != null) {
                    d = (ThePrince)ent;
                    if (this.func_70909_n()) {
                        d.func_70903_f(true);
