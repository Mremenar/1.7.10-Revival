...
public class DungeonSpawnerBlock extends BlockReed
{
    ...
    public void func_149734_b(final World par1World, final int par2, final int par3, final int par4, final Random par5Random) {
        for (int j1 = 0; j1 < 5; ++j1) {
            par1World.func_72869_a("fireworksSpark", (double)(par2 + par1World.field_73012_v.nextFloat()), par3 + (double)par1World.field_73012_v.nextFloat(), (double)(par4 + par1World.field_73012_v.nextFloat()), (par1World.field_73012_v.nextFloat() - par1World.field_73012_v.nextFloat()) / 4.0, par1World.field_73012_v.nextFloat() / 2.0, (par1World.field_73012_v.nextFloat() - par1World.field_73012_v.nextFloat()) / 4.0);
        }
    }
    ...
    public void func_149674_a(final World world, final int clickedX, final int clickedY, final int clickedZ, final Random par5Random) {
        if (world.field_72995_K) {
            return;
        }
        ...
        final int type = world.field_73012_v.nextInt(50);
        if (type == 0) {
