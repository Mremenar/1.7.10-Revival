...
public class WorldProviderOreSpawn extends WorldProvider
{
    ...
    public WorldProviderOreSpawn() {
        this.MyPlains = (BiomeGenUtopianPlains)new BiomeGenUtopianPlains(OreSpawnMain.BiomeUtopiaID).func_76739_b(353825).func_76735_a("Utopia").func_76732_a(0.7f, 0.5f);
    }
    ...
    public IChunkProvider func_76555_c() {
        return (IChunkProvider)new ChunkProviderOreSpawn(this.field_76579_a, this.field_76579_a.func_72905_C(), true);
    }
}
