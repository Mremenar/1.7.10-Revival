...
public class FairySword extends ItemSword
{
    ...
    public boolean func_77644_a(final ItemStack par1ItemStack, final EntityLivingBase par2EntityLiving, final EntityLivingBase par3EntityLiving) {
        ...
        if (par2EntityLiving != null && !par2EntityLiving.field_70170_p.field_72995_K) {
            for (int num = 1 + par2EntityLiving.field_70170_p.field_73012_v.nextInt(3), i = 0; i < num; ++i) {
                Fairy r = null;
                r = (Fairy)spawnCreature(par2EntityLiving.field_70170_p, 0, "Fairy", par2EntityLiving.field_70165_t + (par2EntityLiving.field_70170_p.field_73012_v.nextFloat() - par2EntityLiving.field_70170_p.field_73012_v.nextFloat()) * 0.5, par2EntityLiving.field_70163_u + par2EntityLiving.field_70170_p.field_73012_v.nextFloat() + 0.01, par2EntityLiving.field_70161_v + (par2EntityLiving.field_70170_p.field_73012_v.nextFloat() - par2EntityLiving.field_70170_p.field_73012_v.nextFloat()) * 0.5);
                if (r != null) {
