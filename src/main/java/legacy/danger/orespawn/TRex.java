...
public class TRex extends EntityMob
{
    ...
    protected void func_70628_a(final boolean par1, final int par2) {
        ...
        for (int var4 = 2 + this.field_70170_p.field_73012_v.nextInt(4), i = 0; i < var4; ++i) {
    ...
    public boolean func_70601_bi() {
        ...
        TRex target = null;
        target = (TRex)this.field_70170_p.func_72857_a((Class)TRex.class, this.field_70121_D.func_72314_b(24.0, 12.0, 24.0), (Entity)this);
        return target == null;
    }
}
