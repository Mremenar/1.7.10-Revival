...
public class ModelChainsaw extends ModelBase
{
    ...
    public ModelChainsaw() {
        ...
        (this.engine = new ModelRenderer((ModelBase)this, 0, 19)).func_78789_a(-2.0f, -4.0f, -4.0f, 4, 7, 8);
        ...
        (this.handle1 = new ModelRenderer((ModelBase)this, 49, 0)).func_78789_a(0.0f, -3.0f, 3.0f, 1, 1, 5);
        ...
        (this.handle2 = new ModelRenderer((ModelBase)this, 50, 13)).func_78789_a(0.0f, 2.0f, 4.0f, 1, 1, 4);
        ...
        (this.handle3 = new ModelRenderer((ModelBase)this, 52, 7)).func_78789_a(0.0f, -2.0f, 7.0f, 1, 4, 1);
        ...
        (this.muffler = new ModelRenderer((ModelBase)this, 14, 0)).func_78789_a(-3.0f, 0.0f, 1.0f, 1, 3, 3);
        ...
        (this.blade1 = new ModelRenderer((ModelBase)this, 0, 35)).func_78789_a(0.0f, -2.0f, -28.0f, 1, 4, 24);
        ...
        (this.blade2 = new ModelRenderer((ModelBase)this, 0, 8)).func_78789_a(0.0f, -2.5f, -2.5f, 1, 5, 5);
        ...
        (this.tooth = new ModelRenderer((ModelBase)this, 0, 0)).func_78789_a(0.0f, -1.0f, -0.5f, 1, 1, 1);
    ...
    public void render() {
        ...
        blade2.field_78795_f += (float)0.10471975511965977;
        if (this.blade2.field_78795_f > 6.283185307179586) {
