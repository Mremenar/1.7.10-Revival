        ...
        if (this.inGround) {
            ...
            if (var8 != null) {
                if (var8.field_72308_g != null) {
                    final float var18 = MathHelper.func_76133_a(this.field_70159_w * this.field_70159_w + this.field_70181_x * this.field_70181_x + this.field_70179_y * this.field_70179_y);
                    float var19 = (float)MathHelper.func_76143_f(var18 * (double)OreSpawnMain.UltimateBowDamage);
                    ...
                    if (this.func_70241_g()) {
                        var19 += this.field_70146_Z.nextInt((int)var19 / 2 + 2);
                    }
                    DamageSource var20 = null;
                    if (this.field_70250_c == null) {
                        var20 = DamageSource.func_76353_a((EntityArrow)this, (Entity)this);
                    }
                    else {
                        var20 = DamageSource.func_76353_a((EntityArrow)this, this.field_70250_c);
                    }
                    if (this.func_70027_ad()) {
                        var8.field_72308_g.func_70015_d(5);
                    }
                    if (var8.field_72308_g.func_70097_a(var20, var19)) {
                        if (var8.field_72308_g instanceof EntityLiving) {
                            final EntityLiving var21 = (EntityLiving)var8.field_72308_g;
                            if (!this.field_70170_p.field_72995_K) {
                                var21.func_85034_r(var21.func_85035_bI() + 1);
                            }
                            if (this.knockbackStrength > 0) {
                                ...
                                if (var22 > 0.0f) {
                                    var8.field_72308_g.func_70024_g(this.field_70159_w * this.knockbackStrength * 0.6000000238418579 / var22, 0.1, this.field_70179_y * this.knockbackStrength * 0.6000000238418579 / var22);
                                }
                            }
                    ...
                    final float var18 = MathHelper.func_76133_a(this.field_70159_w * this.field_70159_w + this.field_70181_x * this.field_70181_x + this.field_70179_y * this.field_70179_y);
                    this.field_70165_t -= this.field_70159_w / var18 * 0.05;
                    this.field_70163_u -= this.field_70181_x / var18 * 0.05;
                    this.field_70161_v -= this.field_70179_y / var18 * 0.05;
                    this.func_85030_a("random.bowhit", 1.0f, 1.2f / (this.field_70146_Z.nextFloat() * 0.2f + 0.9f));
                    this.inGround = true;
            ...
            final float var18 = MathHelper.func_76133_a(this.field_70159_w * this.field_70159_w + this.field_70179_y * this.field_70179_y);
            this.field_70177_z = (float)(Math.atan2(this.field_70159_w, this.field_70179_y) * 180.0 / 3.141592653589793);
            this.field_70125_A = (float)(Math.atan2(this.field_70181_x, var18) * 180.0 / 3.141592653589793);
            ...
            if (this.func_70090_H()) {
                for (int var24 = 0; var24 < 4; ++var24) {
                    ...
                    this.field_70170_p.func_72869_a("bubble", this.field_70165_t - this.field_70159_w * var22, this.field_70163_u - this.field_70181_x * var22, this.field_70161_v - this.field_70179_y * var22, this.field_70159_w, this.field_70181_x, this.field_70179_y);
                }
                var23 = 0.8f;
            }
