...
public class LurkingTerror extends EntityMob
{
    ...
    protected boolean func_70692_ba() {
        return !this.func_104002_bU() && this.getAttacking() == 0;
    }
    ...
    public boolean func_70601_bi() {
        ...
        target = (LurkingTerror)this.field_70170_p.func_72857_a((Class)LurkingTerror.class, this.field_70121_D.func_72314_b(32.0, 16.0, 32.0), (Entity)this);
        return target == null && this.field_70163_u >= 10.0;
    }
