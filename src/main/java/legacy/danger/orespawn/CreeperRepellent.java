...
public class CreeperRepellent extends BlockTorch
{
    ...
    private void findSomethingToRepell(final World par1World, final int par2, final int par3, final int par4) {
        final AxisAlignedBB bb = AxisAlignedBB.func_72330_a(par2 - 20.0, par3 - 10.0, par4 - 20.0, par2 + 20.0, par3 + 10.0, par4 + 20.0);
        ...
        while (var6.hasNext()) {
            ...
            if (var7 != null && var7 instanceof PurplePower) {
                ...
                entityLivingBase5.field_70159_w += f * Math.sin(d4);
                final EntityLivingBase entityLivingBase6 = var7;
                entityLivingBase6.field_70179_y += f * Math.cos(d4);
            }
        }
    }
