...
public class EmperorScorpion extends EntityMob
{
    ...
    protected void func_70628_a(final boolean par1, final int par2) {
        ...
        for (int i = 4 + this.field_70170_p.field_73012_v.nextInt(5), var4 = 0; var4 < i; ++var4) {
            this.dropItemRand(Item.func_150898_a(Blocks.field_150343_Z), 1);
        }
        ...
        if (this.field_70170_p.field_73012_v.nextInt(4) == 0) {
            ...
            if (e != null) {
                ...
                if (this.field_70170_p.field_73012_v.nextInt(20) == 1) {
                    final EntityCreature newent = (EntityCreature)spawnCreature(this.field_70170_p, "Scorpion", (this.field_70165_t + e.field_70165_t) / 2.0 + this.field_70170_p.field_73012_v.nextInt(5) - this.field_70170_p.field_73012_v.nextInt(5), (this.field_70163_u + e.field_70163_u) / 2.0 + 1.01, (this.field_70161_v + e.field_70161_v) / 2.0 + this.field_70170_p.field_73012_v.nextInt(5) - this.field_70170_p.field_73012_v.nextInt(5));
                }
            }
            else {
                this.setAttacking(0);
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.field_70170_p.func_72872_a((Class)EntityLivingBase.class, this.field_70121_D.func_72314_b(24.0, 6.0, 24.0));
    ...
    public boolean func_70601_bi() {
        ...
        target = (EmperorScorpion)this.field_70170_p.func_72857_a((Class)EmperorScorpion.class, this.field_70121_D.func_72314_b(20.0, 6.0, 20.0), (Entity)this);
        return target == null;
    }
}
