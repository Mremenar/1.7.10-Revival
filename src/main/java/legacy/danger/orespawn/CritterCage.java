...
public class CritterCage extends Item
{
    ...
    public ItemStack func_77659_a(final ItemStack par1ItemStack, final World par2World, final EntityPlayer par3EntityPlayer) {
        ...
        if (this.cage_id == cc.cage_id) {
            ...
            par2World.func_72956_a((Entity)par3EntityPlayer, "random.bow", 0.5f, 0.4f / (CritterCage.field_77697_d.nextFloat() * 0.4f + 0.8f));
    ...
    public boolean func_77648_a(final ItemStack par1ItemStack, final EntityPlayer par2EntityPlayer, final World par3World, final int par4, final int par5, final int par6, final int par7, final float par8, final float par9, final float par10) {
        ...
        for (int var3 = 0; var3 < 6; ++var3) {
            par2EntityPlayer.field_70170_p.func_72869_a("smoke", (double)(par4 + 0.5f), (double)(par5 + 1.25f), (double)(par6 + 0.5f), 0.0, 0.0, 0.0);
            par2EntityPlayer.field_70170_p.func_72869_a("explode", (double)(par4 + 0.5f), (double)(par5 + 1.25f), (double)(par6 + 0.5f), 0.0, 0.0, 0.0);
            par2EntityPlayer.field_70170_p.func_72869_a("reddust", (double)(par4 + 0.5f), (double)(par5 + 1.25f), (double)(par6 + 0.5f), 0.0, 0.0, 0.0);
        }
