...
public class Irukandji extends EntityMob
{
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.field_70170_p.func_72872_a((Class)EntityLivingBase.class, this.field_70121_D.func_72314_b(6.0, 4.0, 6.0));
    ...
    private int findBuddies() {
        final List var5 = this.field_70170_p.func_72872_a((Class)Irukandji.class, this.field_70121_D.func_72314_b(16.0, 8.0, 16.0));
        return var5.size();
    }
    
    public boolean func_70601_bi() {
        return this.field_70163_u >= 50.0 && this.field_70170_p.func_72935_r() && this.field_70170_p.field_73012_v.nextInt(60) == 1 && this.findBuddies() <= 2;
    }
}
