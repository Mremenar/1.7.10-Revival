...
public class ModelTshirt extends ModelBase
{
    ...
    public ModelTshirt(final float f1) {
        ...
        (this.Shape1 = new ModelRenderer((ModelBase)this, 0, 0)).func_78789_a(-128.0f, -64.0f, 0.0f, 256, 64, 1);
        this.Shape1.func_78793_a(0.0f, -128.0f, 0.0f);
        this.Shape1.func_78787_b(512, 256);
        this.Shape1.field_78809_i = true;
        this.setRotation(this.Shape1, 0.0f, 0.0f, 0.0f);
        (this.Shape2 = new ModelRenderer((ModelBase)this, 0, 64)).func_78789_a(-64.0f, 0.0f, 0.0f, 128, 128, 1);
