...
public class WorldProviderOreSpawn6 extends WorldProvider
{
    ...
    public WorldProviderOreSpawn6() {
        this.MyPlains = (BiomeGenUtopianPlains)new BiomeGenUtopianPlains(OreSpawnMain.BiomeChaosID).func_76739_b(353825).func_76735_a("Chaos").func_76732_a(0.7f, 0.5f);
    }
    ...
    public IChunkProvider func_76555_c() {
        return (IChunkProvider)new ChunkProviderOreSpawn6(this.field_76579_a, this.field_76579_a.func_72905_C());
    }
}
