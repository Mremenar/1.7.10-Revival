...
public class ChunkProviderOreSpawn implements IChunkProvider
{
    ...
    public List func_73155_a(final EnumCreatureType par1EnumCreatureType, final int par2, final int par3, final int par4) {
        ...
        var4 = this.worldObj.func_72807_a(par2, par4);
        if (var4 == null) {
            return null;
        }
        l = var4.func_76747_a(par1EnumCreatureType);
        if (l == null) {
            return null;
        }
        ...
        if (par1EnumCreatureType == EnumCreatureType.ambient) {
            if (this.MyAmbientList == null) {
                ...
                while (var2.hasNext()) {
                    var3 = var2.next();
                    if (var3.field_76300_b == EntityHorse.class) {
                        continue;
                    }
        ...
        while (var2.hasNext()) {
            var3 = var2.next();
            if (var3 != null && var3.field_76300_b != EntityHorse.class) {
                m.add(var3);
            }
        }
        return m;
