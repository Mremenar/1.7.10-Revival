...
public class Alien extends EntityMob
{
    ...
    public void func_70636_d() {
        ...
        if (this.field_70170_p.field_72995_K) {
            final float f = 1.7f + Math.abs(this.field_70170_p.field_73012_v.nextFloat() * 0.75f);
            if (this.field_70170_p.field_73012_v.nextInt(20) == 1) {
                this.field_70170_p.func_72869_a("dripLava", this.field_70165_t - f * Math.sin(Math.toRadians(this.field_70759_as)), this.field_70163_u + 1.6, this.field_70161_v + f * Math.cos(Math.toRadians(this.field_70759_as)), 0.0, 0.0, 0.0);
            }
        }
    }
    ...
    protected void func_70619_bc() {
        ...
        if (this.field_70170_p.field_73012_v.nextInt(40) == 1 && this.func_110143_aJ() < this.mygetMaxHealth()) {
