...
public class Hammerhead extends EntityMob
{
    ...
    private void dropItemRand(final Item index, final int par1) {
        final EntityItem var3 = new EntityItem(this.field_70170_p, this.field_70165_t + OreSpawnMain.OreSpawnRand.nextInt(5) - OreSpawnMain.OreSpawnRand.nextInt(5), this.field_70163_u + 2.0, this.field_70161_v + OreSpawnMain.OreSpawnRand.nextInt(5) - OreSpawnMain.OreSpawnRand.nextInt(5), new ItemStack(index, par1, 0));
    ...
    protected void func_70628_a(final boolean par1, final int par2) {
        ...
        for (int var4 = 0; var4 < 4; ++var4) {
            this.dropItemRand(Item.func_150898_a(OreSpawnMain.CreeperRepellent), 1);
        }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.field_70170_p.func_72872_a((Class)EntityLivingBase.class, this.field_70121_D.func_72314_b(18.0, 9.0, 18.0));
    ...
    public boolean func_70601_bi() {
        ...
        target = (Hammerhead)this.field_70170_p.func_72857_a((Class)Hammerhead.class, this.field_70121_D.func_72314_b(16.0, 8.0, 16.0), (Entity)this);
        return target == null;
    }
}
