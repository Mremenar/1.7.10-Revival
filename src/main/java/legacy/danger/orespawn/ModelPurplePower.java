...
public class ModelPurplePower extends ModelBase
{
    ...
    public ModelPurplePower(final float f1) {
        ...
        (this.Shape1 = new ModelRenderer((ModelBase)this, 0, 12)).func_78789_a(-2.0f, -0.5f, -0.5f, 4, 1, 1);
        this.Shape1.func_78793_a(0.0f, 0.0f, 0.0f);
        this.Shape1.func_78787_b(64, 32);
        this.Shape1.field_78809_i = true;
        this.setRotation(this.Shape1, 0.0f, 0.0f, 0.0f);
        (this.Shape2 = new ModelRenderer((ModelBase)this, 0, 7)).func_78789_a(-4.0f, -0.5f, -0.5f, 8, 1, 1);
        this.Shape2.func_78793_a(0.0f, 0.0f, 0.0f);
        this.Shape2.func_78787_b(64, 32);
        this.Shape2.field_78809_i = true;
        this.setRotation(this.Shape2, 0.0f, 0.0f, 0.0f);
        (this.Shape3 = new ModelRenderer((ModelBase)this, 0, 0)).func_78789_a(-7.0f, -0.5f, -0.5f, 14, 1, 1);
