    ...
    public void func_70071_h_() {
        ...
        if (this.field_70170_p.field_72995_K && this.getPower() > 400) {
            ...
            if (this.field_70170_p.field_73012_v.nextInt(6) == 1) {
                for (int i = 0; i < 2; ++i) {
                    this.field_70170_p.func_72869_a("fireworksSpark", this.field_70165_t - f * Math.sin(Math.toRadians(this.field_70177_z)), this.field_70163_u + 0.4, this.field_70161_v + f * Math.cos(Math.toRadians(this.field_70177_z)), (this.field_70170_p.field_73012_v.nextGaussian() - this.field_70170_p.field_73012_v.nextGaussian()) / 7.0 + this.field_70159_w * 3.0, (this.field_70170_p.field_73012_v.nextGaussian() - this.field_70170_p.field_73012_v.nextGaussian()) / 7.0, (this.field_70170_p.field_73012_v.nextGaussian() - this.field_70170_p.field_73012_v.nextGaussian()) / 7.0 + this.field_70179_y * 3.0);
                }
            }
        }
    }
        ...
        if (this.attack_level > 500) {
            if (this.getAttacking() != 0) {
                ...
                if (this.field_70170_p.func_82736_K().func_82766_b("mobGriefing")) {
                    for (int m = 0; m < 5; ++m) {
                        final int i = this.field_70170_p.field_73012_v.nextInt(5) - this.field_70170_p.field_73012_v.nextInt(5);
                        final int k = this.field_70170_p.field_73012_v.nextInt(5) - this.field_70170_p.field_73012_v.nextInt(5);
                        int j = -5;
                        while (j < 5) {
                            ...
                            if (bid == Blocks.field_150349_c) {
                                ...
                                final int which = this.field_70170_p.field_73012_v.nextInt(8);
                                if (which == 0) {
                ...
                for (int m = 0; m < 2; ++m) {
                    final int i = this.field_70170_p.field_73012_v.nextInt(4) - this.field_70170_p.field_73012_v.nextInt(4);
                    final int k = this.field_70170_p.field_73012_v.nextInt(4) - this.field_70170_p.field_73012_v.nextInt(4);
                    final int j = 1 + this.field_70170_p.field_73012_v.nextInt(4);
                    final Block bid = this.field_70170_p.func_147439_a((int)this.field_70165_t + i, (int)this.field_70163_u + j, (int)this.field_70161_v + k);
