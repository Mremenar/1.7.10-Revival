...
public class BasiliskMaze
{
    ...
    public void buildBasiliskMaze(final World world, final int x, final int y, final int z) {
        final int depth = 20 + world.field_73012_v.nextInt(10);
    ...
    private void openMaze(final World world, final int xx, final int yy, final int zz, final int xw, final int zw, final int csz) {
        for (int i = 0; i < zw * csz; ++i) {
            final Block bid = world.func_147439_a(xx + 1, yy, zz + i);
        ...
        for (int i = zw * csz - 1; i >= 0; --i) {
            final Block bid = world.func_147439_a(xx + xw * csz - 2, yy, zz + i);
            if (bid == Blocks.field_150350_a) {
    ...
    private void buildCastle(final World world, final int x, final int y, final int z) {
        ...
        for (int i = 2 + world.field_73012_v.nextInt(3), k = 0; k < i; ++k) {
            ...
            if (chest != null) {
                WeightedRandomChestContent.func_76293_a(world.field_73012_v, this.chestContentsList, (IInventory)chest, 5 + world.field_73012_v.nextInt(6));
            }
        }
        Entity ent = null;
