...
public class CrystalMaze
{
    ...
    private void openCrystalMaze(final World world, final int xx, final int yy, final int zz, final int xw, final int zw, final int csz, final Chunk chunk) {
        ...
        for (int k = 0; k < 4; ++k) {
            final int i = world.field_73012_v.nextInt(zw * csz);
            final int j = world.field_73012_v.nextInt(zw * csz);
            OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, xx + j, yy + 3, zz + i, OreSpawnMain.CrystalStone, 0);
        }
        int i = world.field_73012_v.nextInt(zw * csz);
        int j = world.field_73012_v.nextInt(zw * csz);
